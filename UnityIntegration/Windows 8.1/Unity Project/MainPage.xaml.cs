...
namespace Unity_Project
{
	...
	public sealed partial class MainPage : Page
	{
        ...
        private void AdControl_AdLoadingError(object sender, AdDuplex.Universal.Win.WinRT.Models.AdLoadingErrorEventArgs e)
        {

        }

        private void AdControl_AdCovered(object sender, AdDuplex.Universal.Win.WinRT.Core.AdCoveredEventArgs e)
        {
